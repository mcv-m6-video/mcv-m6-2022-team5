...
# Model Parameters
selected_model = 'COCO-Detection/faster_rcnn_R_101_FPN_3x.yaml'
...
for i, seq in enumerate(train):
    for j, cam in tqdm(enumerate(CAMERAS[seq]), total = len(CAMERAS[seq]), desc = f"Processing {seq}..."):
        ...
        data["frames"] = extract_video(cam + "vdo.avi", 1, 1)
...
cfg.OUTPUT_DIR = "./results_train_seq01_faterRCNN"
...
dataset_dicts = get_AICity_dicts_big(seq_data)
img_filename = '../datasets/aic19-track1-mtmc-train/train/S01/c002/frames/vdo_8.png'
